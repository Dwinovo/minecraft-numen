 ...
 * ({@link ServerToolTransport#ship}) and parks it; core's {@code ExecuteToolPayload}
...
public abstract class ServerNumenTool implements NumenTool {
    ...
    public final void invoke(ToolCall call) {
        ServerToolTransport.ship(call);   // client side: ship to the body, park the call until the result returns
    }
