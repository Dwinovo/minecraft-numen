 ...
 * 本包根部只住注册器与跨车道共享助手(ToolParse/MenuOps/各 *Tools 实现类)。
 *
 * <h2>新增工具的四连问(按顺序问,答案即归属)</h2>
 * <ol>
 *   <li><b>需要摸服务端的世界吗?(读或写都算)</b><br>
 *       不需要(查会话/操作 UI/调外部服务)→ {@link com.dwinovo.numen.core.tools.query}:
 *       在 invoke 里干完,当场 complete。</li>
 ...
 *       TaskChain 参与竞价,工具只做开关(开关本身是 query,当场返回)。</li>
 * </ol>
 *
 * <h2>选错的代价(为什么值得问)</h2>
 * <ul>
 ...
 *   <li>该 query 却进队:身体被长活占着时,一句"附近有什么"都会被拒。</li>
 * </ul>
 */
