...
public final class MoveToTool implements NumenTool {
    ...
    public String description() {
        return """
                ...
                • Go to a BLOCK to use it (chest, crafting table, furnace, ore…): give block:'<its name>'. Alone = it scans nearby and walks up beside the closest one; WITH x,y,z = walks up beside that specific one (when you know exactly which). Either way it stops right beside it, never touches it, and reports its position.
    ...
    public Map<String, Object> parameterSchema() {
        return Schema.object()
                ...
                .optionalString("block", "Namespaced block id of a block to walk up BESIDE (e.g. "
                        ...
                        + "Alone = nearest one found by scanning; with x,y,z = that specific one. "
