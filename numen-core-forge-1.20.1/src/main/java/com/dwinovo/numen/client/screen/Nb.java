...
public final class Nb {
    ...
    public static Component colored(String s, int color) {
        return Component.nullToEmpty(s).copy().setStyle(net.minecraft.network.chat.Style.EMPTY.withColor(TextColor.fromRgb(color & 0xFFFFFF)));
    }
    ...
    public static void text(GuiGraphics g, Font font, Component c, int x, int y, int color) {
        g.drawString(font, c.copy().withStyle(c.getStyle().withColor(TextColor.fromRgb(color & 0xFFFFFF))), x, y, -1, false);
    }
