...
public final class PathVizRenderer {
    ...
    private static void line(VertexConsumer vc, PoseStack.Pose pose,
        ...
        vc.vertex(pose.pose(), (float) x1, (float) y1, (float) z1).color(r, g, b, a).normal(nx, ny, nz);
        vc.vertex(pose.pose(), (float) x2, (float) y2, (float) z2).color(r, g, b, a).normal(nx, ny, nz);
    }
}
