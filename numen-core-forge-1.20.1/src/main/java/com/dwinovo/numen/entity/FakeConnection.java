...
public final class FakeConnection extends Connection {
    ...
    public FakeConnection() {
        ...
        // EmbeddedChannel may become active before handlers are fully notified on
        // some Netty/Forge launch paths. Fire the event explicitly so
        // Connection.channelActive always captures the channel before
        // PlayerList.placeNewPlayer configures its pipeline.
