...
public final class ToolCall {
    ...
    public ToolCall(String id, String toolName, String rawArgs, ClientToolContext ctx,
        ...
        this(id, toolName, rawArgs, ctx, false, completion);
    }

    public ToolCall(String id, String toolName, String rawArgs, ClientToolContext ctx,
                    boolean reconnect, Consumer<String> completion) {
        this.id = id;
    ...
    /** True when this call came from persisted conversation recovery. */
