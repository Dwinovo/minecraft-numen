 ...
 */
public record SkillInfo(String name, String description, String content, String compactContent, Path location) {
    public String content(boolean detailed) {
        return detailed || compactContent == null || compactContent.isBlank() ? content : compactContent;
    }
}
