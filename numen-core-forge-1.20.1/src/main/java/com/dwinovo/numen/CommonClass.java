...
public class CommonClass {
    ...
    public static void registerTools() {
        if (ToolRegistry.get("request_tool_group") == null) {
            ToolRegistry.register(new com.dwinovo.numen.client.agent.RequestToolGroupTool());
        }
        if (ToolRegistry.get("web_search") == null) {
            ToolRegistry.register(new com.dwinovo.numen.client.agent.WebSearchTool());
        }
