...
public record LocateNumenPayload(List<UUID> entityUuids) {
    ...
    public void encode(FriendlyByteBuf buf) {
        int size = Math.min(entityUuids.size(), MAX_UUIDS);
    ...
    public static LocateNumenPayload decode(FriendlyByteBuf buf) {
    ...
    public static void handle(LocateNumenPayload p, ServerPlayer player) {
        ...
        Services.NETWORK.sendToPlayer(player, NumenLocationsPayload.ID, new NumenLocationsPayload(out));
    }
}
