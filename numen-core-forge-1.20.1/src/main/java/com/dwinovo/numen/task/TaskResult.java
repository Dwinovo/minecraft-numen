...
public record TaskResult(boolean success,
    ...
    public static TaskResult fail(String message, String code, Map<String, Object> data) {
        return fail(message, withFailureCode(code, data));
    }
    ...
    public static TaskResult timeout(String message, String code, Map<String, Object> data) {
        return new TaskResult(false, message, true, false, withFailureCode(code, data));
    }
    ...
    public static TaskResult cancelled(String message, String code, Map<String, Object> data) {
        return new TaskResult(false, message, false, true, withFailureCode(code, data));
    }

    private static Map<String, Object> withFailureCode(String code, Map<String, Object> data) {
        java.util.LinkedHashMap<String, Object> out = new java.util.LinkedHashMap<>();
        if (data != null) out.putAll(data);
        if (code != null && !code.isBlank()) out.put("failure_code", code);
        return out;
    }
    ...
    public String toJson() {
        ...
        if (data != null && !data.isEmpty()) {
            ...
            for (Map.Entry<String, Object> e : data.entrySet()) {
                if (e.getValue() != null) dataObj.add(e.getKey(), GSON.toJsonTree(e.getValue()));
            }
