...
public final class LoadSkillTool implements NumenTool {
    ...
    public void invoke(ToolCall call) {
        try {
            ...
            boolean detailed = com.dwinovo.numen.client.agent.CompanionAiConfigStore
                    .get(call.ctx().entityUuid()).lowQualityAi();
            call.complete(impl.loadSkill(a.name(), detailed));
