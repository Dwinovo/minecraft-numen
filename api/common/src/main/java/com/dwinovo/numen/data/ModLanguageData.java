...
public final class ModLanguageData {
    ...
    private static void addEn(Adder adder) {
        ...
        adder.add("numen.empty.no_companions", "No companions yet. Open the menu at the top left to summon one.");
        ...
        adder.add("numen.profile.model_of", "Model · %s");
        ...
        adder.add("numen.profile.context", "Context · %s lines · %s used");
        ...
        adder.add("numen.profile.state", "Status");
        adder.add("numen.profile.state_external", "Driven by an external brain");
        adder.add("numen.profile.state_compact", "Tidying memory");
        adder.add("numen.profile.state_busy", "Busy");
        adder.add("numen.profile.state_queued", "%s queued");
        adder.add("numen.profile.state_idle", "Idle");
        adder.add("numen.profile.not_started", "Not talked yet");
    ...
    private static void addZh(Adder adder) {
        ...
        adder.add("numen.empty.no_companions", "还没有同伴。点左上角的菜单召唤一个。");
        ...
        adder.add("numen.profile.model_of", "模型 · %s");
        ...
        adder.add("numen.profile.context", "上下文 · %s 条 · 已用 %s");
        ...
        adder.add("numen.profile.state", "状态");
        adder.add("numen.profile.state_external", "外接大脑驱动中");
        adder.add("numen.profile.state_compact", "整理记忆中");
        adder.add("numen.profile.state_busy", "忙碌中");
        adder.add("numen.profile.state_queued", "积压 %s 条");
        adder.add("numen.profile.state_idle", "空闲");
        adder.add("numen.profile.not_started", "尚未对话");
