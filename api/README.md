...
dependencies {
    ...
    modCompileOnly "com.dwinovo.numen:numen-api-fabric-26.1.2:0.0.10:api"

    // NeoForge / Forge：运行期命名就是 Mojang 命名，直接 compileOnly
    // compileOnly "com.dwinovo.numen:numen-api-neoforge-26.1.2:0.0.10:api"
}
```
...
```gradle
dependencies {
    modImplementation "com.dwinovo.numen:numen-neoforge-26.1.2:0.1.2"
}
```
