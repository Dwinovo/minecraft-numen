...
![Version](https://img.shields.io/maven-metadata/v?metadataUrl=https%3A%2F%2Fraw.githubusercontent.com%2FDwinovo%2Fnumen-maven%2Fmain%2Fcom%2Fdwinovo%2Fnumen%2Fnumen-api-fabric-1.20.6%2Fmaven-metadata.xml&label=version&color=A8731E&style=flat-square)
...
dependencies {
    ...
    modCompileOnly "com.dwinovo.numen:numen-api-fabric-1.20.6:<version>:api"

    // NeoForge / Forge：运行期命名就是 Mojang 命名，直接 compileOnly
    // compileOnly "com.dwinovo.numen:numen-api-neoforge-1.20.6:<version>:api"
}
```
...
```gradle
dependencies {
    modImplementation "com.dwinovo.numen:numen-neoforge-1.20.6:<version>"
}
```
