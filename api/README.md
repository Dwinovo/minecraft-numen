...
dependencies {
    ...
    modCompileOnly "com.dwinovo.numen:numen-api-fabric-1.20.4:0.0.10:api"

    // NeoForge / Forge：运行期命名就是 Mojang 命名，直接 compileOnly
    // compileOnly "com.dwinovo.numen:numen-api-forge-1.20.4:0.0.10:api"
}
```
...
```gradle
dependencies {
    modImplementation "com.dwinovo.numen:numen-forge-1.20.4:0.1.2"
}
```
