...
dependencies {
    ...
    modCompileOnly "com.dwinovo.numen:numen-api-fabric-1.21.4:0.0.10:api"

    // NeoForge / Forge: runtime names are Mojang names, so plain compileOnly works.
    // compileOnly "com.dwinovo.numen:numen-api-neoforge-1.21.4:0.0.10:api"
}
```
...
```gradle
dependencies {
    modImplementation "com.dwinovo.numen:numen-neoforge-1.21.4:0.1.2"
}
```
