...
![Version](https://img.shields.io/maven-metadata/v?metadataUrl=https%3A%2F%2Fraw.githubusercontent.com%2FDwinovo%2Fnumen-maven%2Fmain%2Fcom%2Fdwinovo%2Fnumen%2Fnumen-api-fabric-1.21%2Fmaven-metadata.xml&label=version&color=A8731E&style=flat-square)
...
dependencies {
    ...
    modCompileOnly "com.dwinovo.numen:numen-api-fabric-1.21:<version>:api"

    // NeoForge / Forge: runtime names are Mojang names, so plain compileOnly works.
    // compileOnly "com.dwinovo.numen:numen-api-neoforge-1.21:<version>:api"
}
```
...
```gradle
dependencies {
    modImplementation "com.dwinovo.numen:numen-neoforge-1.21:<version>"
}
```
