...
The engine (`api/`) has been merged into this repository on 1.21.1 and 1.21.4, with the other version branches following. It is still published under its own coordinates for third parties, and depending on it hasn't changed:
