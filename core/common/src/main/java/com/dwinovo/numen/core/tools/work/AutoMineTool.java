...
public final class AutoMineTool implements NumenTool {
    ...
    public String description() {
        return "Gather blocks, in one of two ways. block_ids + count: she finds the nearest blocks of those "
                ...
                + "qualifies (to destroy a block regardless of drops, goto beside it and run use block left "
                + "on it). spec is goto's spec object laid over mine's own default, which may dig "
