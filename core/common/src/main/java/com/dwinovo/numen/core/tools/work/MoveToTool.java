...
public final class MoveToTool implements NumenTool {
    ...
    public String description() {
        return """
                ...
                • x+y+z — stand EXACTLY in that cell (a cell occupied by a block counts as reached when she stands right beside it). Use only when the exact feet cell matters.
