...
This is a long fight. Between every tool call: `get_self_status`; **HP ≤ 10 → disengage to centre, `inv eat`, only then re-engage.** The dragon doesn't rush you — patience is free, death isn't.
