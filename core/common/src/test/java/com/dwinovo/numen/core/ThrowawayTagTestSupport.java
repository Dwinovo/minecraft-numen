...
/**
 * 给无头测试绑上出厂 throwaway 标签。
 *
 * <p>{@code numen:throwaway} 的内容来自数据包,而 {@code Bootstrap.bootStrap()} 只建注册表、
 * 不加载数据包。不绑的话标签是空的,于是"她一件 throwaway 方块都没有"——寻路里所有垫柱/搭桥判成
 ...
 */
public final class ThrowawayTagTestSupport {
    ...
    private ThrowawayTagTestSupport() {}
