 ...
 */
public record NumenTestEnvironment(int time) implements TestEnvironmentDefinition<net.minecraft.util.Unit> {
    ...
    @Override
    public net.minecraft.util.Unit setup(ServerLevel level) {
        ...
        // 游戏规则住 net.minecraft.world.level.gamerules,GameRule<T> + map 形态:
        // 取规则对象再 set(值, server)。
     ...
     */
    @Override
    public void teardown(ServerLevel level, net.minecraft.util.Unit saveData) {
    }
